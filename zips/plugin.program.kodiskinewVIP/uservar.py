...
#        User Edit Variables                            #
#########################################################
ADDONTITLE = '[COLOR limegreen][B]kodsikinewVIPWizard[/B][/COLOR]'
BUILDERNAME = 'kodsikinewVIP'
EXCLUDES = [ADDON_ID, 'repository.openwizard']
# Text File with build info in it.
BUILDFILE = 'https://kodiskinewvip.github.io/wizard19/build/builds.txt'
...
THEME1 = u'[COLOR {color1}][I]([COLOR {color1}][B]kodsikinewVIP [/B][/COLOR][COLOR {color2}]VIP[COLOR {color1}]) [/I][/COLOR] [COLOR {color2}]{{}}[/COLOR]'.format(color1=COLOR1, color2=COLOR2)
...
REPOADDONXML = 'https://raw.githubusercontent.com/kodiskinewVIP/repo/main/addons.xml'
# Url to folder zip is located in
REPOZIPURL = 'https://kodiskinewvip.github.io/repo/'
#########################################################
...
NOTIFICATION = 'https://kodiskinewvip.github.io/wizard19/build/notify.txt'
# Use either 'Text' or 'Image'
HEADERTYPE = 'Text'
# Font size of header
FONTHEADER = 'Font14'
HEADERMESSAGE = '[COLOR limegreen][B]kodsikinewVIP[/B][/COLOR]'
# url to image if using Image 424x180
HEADERIMAGE = 'https://avatars.githubusercontent.com/u/134120961?v=4'
# Font for Notification Window
FONTSETTINGS = 'Font13'
# Background for Notification Window
BACKGROUND = 'https://kodiskinewvip.github.io/wizard19/build/themes.txt'
#########################################################
